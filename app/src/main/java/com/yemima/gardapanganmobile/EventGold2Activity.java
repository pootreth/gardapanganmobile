...
public class EventGold2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_gold2);
        ...
        //beda
        view1=findViewById(R.id.contenteventgold2);
        view2=findViewById(R.id.contentsplitgold2);
    ...
    chat=findViewById(R.id.chatgold);
        ...
        @Override
        public void onClick(View v) {
            Intent pindahmain = new Intent(EventGold2Activity.this, ChatActivity.class);
    ...
    report=findViewById(R.id.report);
        ...
        @Override
        public void onClick(View v) {
            Intent pindahmain = new Intent(EventGold2Activity.this, ReportActivity.class);
            startActivity(pindahmain);
        }
    });
    }
